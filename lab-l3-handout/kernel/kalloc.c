...
// I cant seem to figure out what this number really should be. Should also probably use definitions
// from memlayout.h, but i cant seem to figure out what to use. I get the test to pass using the number below
// but i dont know if it is correct.
int reference_counter[32768];
